...
//		데이터 입력 단계에서 불필요한 공백을 제거하고 입력 받으려면 아래와 같이 trim() 메소드를 사용하면 된다.
...
//		substring(a, b): 문자열의 a번째 index의 문자부터 b-1번째 index의 문자까지 얻어온다.
		...
		System.out.println("주민등록번호 앞자리: " + str.substring(0,7));
...
//		indexOf(), lastIndexOf() 메소드의 실행결과가 0 이상이면 인수로 지정된 문자열이 포함되었다는
//		의미로 사용할 수 있다.
