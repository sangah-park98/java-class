...
//		System.out.println(calendar.isLeapYear(2023)); //2줄
//		
//		System.out.println(MyCalendar.isLeapYear(2023));
//		//1줄(자주 사용하는 건 static 사용, 클래스. 찍어서 사용)
		...
		System.out.println("---------------------------");
//		1일이 출력될 요일을 맞추기 위해 요일만큼 반복하며 빈칸 (날짜당 4칸)을 출력한다.		
...
//		날짜를 다 출력하고 남은 빈칸에 다음 달 1일의 요일부터 토요일까지 반복하며 다음 달 날짜를 출력한다.
//		if(month == 12) {
//			week = MyCalendar.weekDay(year+1, 1, 1); //week: 다음 달 요일
//		} else {
