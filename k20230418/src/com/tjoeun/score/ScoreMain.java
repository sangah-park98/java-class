...
//		count도 수정된다.
		...
		*/
		...
		ScoreVO score2 = new ScoreVO("임꺽정", 45, 80, 99);
		ScoreVO score3 = new ScoreVO("장길산", 67, 70, 99);
		ScoreVO score4 = new ScoreVO("일지매", 89, 40, 66);
		ScoreVO score5 = new ScoreVO("손오공", 83, 90, 20);
