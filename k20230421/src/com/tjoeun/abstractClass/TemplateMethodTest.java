...
//	자식 클래스에서 다르게 구현되어야 하는 부분은 추상 메소드로 선언해서 자식 클래스에서 Override해서
//	구현하도록 한다.
	
//	변수를 선언할 때 final을 붙여서 선언하면 프로그램에서 override를 할 수 없다. => 상수
...
//		aiCar.NAME = "임꺽정"; // final 변수의 값을 수정하려 했으므로 에러가 발생한다.
		System.out.println(aiCar.NAME);
	}
}
