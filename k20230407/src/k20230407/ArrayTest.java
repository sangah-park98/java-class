...
//		변수는 단독주택, 배열은 아파트
//		배열이란 같은 이름으로 여러 개의 기억장소를 만든다. 기억장소 구분은 인덱스(첨자)를 이용한다.
...
//		자료형[] 배열이름 = {초기치};
		...
		String[] name = {"홍길동", "박상아", "박은별", "개똥이", "사오정", "저팔계"};
...
//		배열이름.length: 배열의 크기를 얻어온다.
		...
		System.out.println("----------------------------------");
//		향상된 for: 배열 전체를 대상으로 작얼할 경우 사용하면 편리하다.
//		for (배열의 자료형 변수이름 : 배열이름) {
//			반복할 문장;
//			...;
//		}
//		name 배열의 0번째 인덱스에 저장된 데이터가 str변수에 저장된 후 반복이 시작되고
