...
//		StringBuilder 클래스는 내부적으로 가변적인 char[] 배열을 멤버 변수(필드)로 가진다.
...
//		StringBuffer 멀티스레드 프로그램에서 동기화(순서를 정한다.)를 보장하므로
//		멀티스레드 프로그램은 StringBuffer를 사용하고 싱글(단일) 스레드 프로그램은
//		StringBuffer를 사용하는 것을 권장한다.
