...
//		제품 만들기 -> 생성자는 옵션의 개념 이렇게도 만들 수 있고 저렇게도 만들 수 있고
...
//		비교할 수 있었지만 사용자 정의 클래스 객체는 단일 데이터가 아니므로 별도의 설정을 하지 않으면
//		equals() 메소드로 비교할 수 없다.
		
		
//		별도의 설정을 하지 않으면 아래의 결과는 "다르다"가 출력된다.
//		클래스 객체를 비교할 때 객체를 구성하는 모든 필드의 내용이 같은가 비교할 수 있도록 
//		equals() 메소드를 Override 해야하고 내용이 동일한 객체는 같은 hashcode를 가질 수 있도록 
//		hashcode() 메소드도 Override를 하면 "같다"가 출력된다.
