...
//	자바는 일반적으로 파일 1개에 1개의 클래스를 만들어 사용하지만 필요에 따라 1개의 파일에 여러 개의
// 	클래스를 만들어 사용할 수 있다.
//	1개의 파일에 여러 개의 클래스를 만들면 "*.java" 파일은 1개가 만들어지지만 컴파일된 "*.class" 파일은 
//	각각 독립적으로 생성된다.
...
class Now extends Date { // 날짜와 시간을 모두 나타내는 클래스
